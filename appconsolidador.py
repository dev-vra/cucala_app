...
CONFIG_FILE_PATH = APP_SUPPORT_DIR / "config.ini" # <-- Usado para salvar login e agora o caminho
...
# NÚCLEO LÓGICO (Sem alterações aqui)
...
class App(ctk.CTk):
    ...
    def show_login_frame(self):
        # ... (código do frame de login permanece o mesmo)
    ...
    def check_login(self, user_entry, pass_entry, remember_me_var, status_label):
        # ... (código de verificação de login permanece o mesmo)
    ...
    # <-- NOVO: Função para carregar as configurações na inicialização
    ...
    # <-- NOVO: Função para o usuário definir/alterar a planilha mestra
    ...
    # <-- ALTERAÇÃO: A interface principal foi reorganizada
    def setup_main_ui(self):
        self.grid_columnconfigure(0, weight=1); self.grid_columnconfigure(1, weight=2)
        # <-- ALTERAÇÃO: A linha 1 (onde fica a lista) agora ocupa todo o espaço vertical
        ...
        # <-- NOVO: Frame para exibir e alterar a planilha mestra
        ...
        # <-- ALTERAÇÃO: A linha 1 agora (lista de arquivos) ocupa todo o espaço
        ...
        # <-- ALTERAÇÃO: Frame de origem agora ocupa a linha 1 e foi expandido
        ...
        # <-- NOVO: Chama a função para carregar o caminho salvo assim que a UI é criada
        self.carregar_configuracoes()
        
    def change_theme(self):
        # ... (código do tema permanece o mesmo)
    ...
    # <-- ALTERAÇÃO: A função selecionar_mestra foi substituída pela definir_planilha_mestra
    # def selecionar_mestra(self): ...

    def selecionar_origem(self):
        # ... (código de selecionar origem permanece o mesmo)
    ...
    def move_up(self):
        # ... (código de mover para cima permanece o mesmo)
    ...
    def move_down(self):
        # ... (código de mover para baixo permanece o mesmo)
        selected_indices = self.listbox.curselection()
        if not selected_indices: return
    ...
    # <-- ALTERAÇÃO: A lógica de execução agora valida o caminho salvo
    def executar(self, modo_atualizacao):
        ...
        # Validação do caminho da planilha mestra
        ...
        # Validação das planilhas de origem
    ...
    def run_consolidation_worker(self, arquivos_para_processar, modo_atualizacao):
        # ... (código do worker permanece o mesmo)
        try:
